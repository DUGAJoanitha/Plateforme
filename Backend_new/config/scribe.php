...
return [
    ...
    'title' => 'Plateforme NGO — API Documentation',

    // A short description of your API.
    'description' => 'API REST pour la gestion de projets humanitaires. Authentification via Laravel Sanctum (Bearer Token).',
    ...
    'auth' => [
        ...
        'extra_info' => 'Obtenez votre token via <code>POST /api/v1/auth/login</code>. Passez-le dans le header : <code>Authorization: Bearer {token}</code>',
    ],
